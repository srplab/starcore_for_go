...
typedef void (SRPAPI *VSScript_CleanUpProc)( VS_UWORD Para, VS_BOOL ClearSrvGroupFlag );    /* if ClearSrvGroupFlag == VS_FALSE, should reserve service group 0,and delete  all other service groups; if ClearSrvGroupFlag == VS_TRUE, delete all service groups; */
...
typedef VS_BOOL (SRPAPI *VSScript_GetRefInfoProc)( VS_UWORD Para, VS_ULONG ServiceGroupIndex,void *Object,VS_UUID *ObjectID, VS_BOOL *IsSLockFlag );
...
struct StructOfCommonRawContextHeader{
    ...
    VS_BOOL IsClass;
    VS_INT8 Reserved[6];    /* align to 8 bytes */
...
struct StructOfVSScriptContext{
    ...
    /*--*/
    VSScript_GILLockProc           GILLockProc;
    VSScript_GILUnLockProc         GILUnLockProc;
...
/*-----*/
    ...
    /*----add 2012/06/25*/
    virtual VS_BOOL SRPAPI InsertParaPackage(VS_INT32 Index,class ClassOfSRPParaPackageInterface *ParaPkg) = 0;  /* the function will addref to input parapkg */
    virtual class ClassOfSRPParaPackageInterface *SRPAPI GetParaPackage(VS_INT32 Index) = 0;    /*---From 0 */
    ...
    virtual VS_CHAR *SRPAPI ToJSon() = 0; /*the even index is key, must be string; the odd index is value, may be SRPPARATYPE_INT,SRPPARATYPE_FLOAT,SRPPARATYPE_CHARPTR,SRPPARATYPE_BOOL,SRPPARATYPE_PARAPKG */
...
#define SRPATOMICQUERYTYPE_ATTRIBUTE     8      /*--Para1:parent atomicobject£¬Para2 ret:AttributeName address£¬Para3 ret:type£¬Para£´ ret:length£¬Para5 ret:struct atomicobject*/
...
/*------------------------------------------------------------------------------*/
	...
	virtual void *SRPAPI GetObjectEx(void *ParentObject,const VS_CHAR *Name) = 0;
	virtual void *SRPAPI GetObjectEx2(const VS_CHAR *ServiceName,const VS_CHAR *Name) = 0;
...
/*------------------------------------------------------------------------------*/
    ...
    virtual void SRPAPI SetName(void *Object,const VS_CHAR *Name) = 0;
...
/*---------get interfaces*/
    ...
    */
    ...
    virtual void SRPAPI DetachRawContext(void *Object,VS_BOOL CallUnLockGC) = 0;
    ...
    virtual VS_BOOL SRPAPI HasRawContext(void *Object) = 0;
    ...
    virtual VS_PARAPKGPTR SRPAPI RawToParaPkg( void *Object ) = 0;   /* if the object is not raw object or can not change to parapkg, then returns NULL */
...
typedef VS_BOOL (SRPAPI *StarCoreService_Init2Proc)( class ClassOfStarCore *StarCore, struct StructOfVSStarCoreInterfaceTable *InterfaceTable );
extern "C" SRPDLLEXPORT VS_BOOL SRPAPI StarCoreService_Init2(class ClassOfStarCore *StarCore, struct StructOfVSStarCoreInterfaceTable *InterfaceTable );  /*--do not save StarCore,it maybe invalid after function return*/
#define VSCORE_STARCORESERVICE_TERM2_NAME "StarCoreService_Term2"
typedef void (SRPAPI *StarCoreService_Term2Proc)( class ClassOfStarCore *StarCore, struct StructOfVSStarCoreInterfaceTable *InterfaceTable  );            /*--StarCore is reserved, and set to NULL*/
